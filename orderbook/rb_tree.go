...
// Production-grade Red-Black Tree implementation for price levels.
// Supports O(log n) insert/delete and ordered iteration.
...
// NewRBTree constructs an empty tree with a black sentinel node.
...
// UpsertLevel inserts or retrieves a price level.
...
// FindLevel retrieves a price level by price or nil if not found.
...
// DeleteLevel removes the level at a given price.
...
// MinLevel returns the lowest price level.
...
// MaxLevel returns the highest price level.
...
// ForEachAscending iterates levels ascending by price.
...
// ForEachDescending iterates levels descending by price.
